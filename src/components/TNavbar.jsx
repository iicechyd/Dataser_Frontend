...
<aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div className="h-full px-4 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800"> 
      <a href="#" >
      <span className="text-[#2A2F3C] text-xl font-bold text-center mb-5">ระบบ</span>
      <span className="text-[#4880FF] text-xl font-bold text-center mb-5">เช็คชื่อ</span>     
      </a>
      ...
      <ul className="space-y-2 font-medium ">
         <li   className="absolute ">
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-2 whitespace-nowrap">รายวิชาที่สอน</span> 
            </a>
         </li>
         
         <li className="absolute pt-10 ">
            <a href="#" className="flex items-center p-2  text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               {/* <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
               ...
               <span className="flex items-center justify-center text-center flex-1 ms-3 whitespace-nowrap p-2 bg-gray-400 text-black rounded-lg cursor-pointer hover:bg-gray-500">
              + สร้างรายวิชา
              </span>
            </a>
         </li>
         
         <li className="absolute bottom-11 ">
            <a href="/" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
